...
export default function PrivacyPolicy() {
    ...
    return (
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Fullstack Music App.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Fullstack Music App, accessible from <a href="http://www.mysite.com" rel="external nofollow noopener" target="_blank">http://www.mysite.com</a></p>
        </li>
        <li>
